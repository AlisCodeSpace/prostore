...
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESC || "An ecommerce platform built with Next.js";
...
export const PAYMENT_METHODS = process.env.PAYMENT_METHODS?.split(',') || ['PayPal', 'Stripe', 'Cash on Delivery'];
